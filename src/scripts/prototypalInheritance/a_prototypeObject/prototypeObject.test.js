...
var userWithAge = require('./').userWithAge;
var firstResult = require('./tasks').firstResult;
var secondResult = require('./tasks').secondResult;
var thirdResult = require('./tasks').thirdResult;
var fourthResult = require('./tasks').fourthResult;
var bed = require('./tasks').bed;
var pockets = require('./tasks').pockets;
